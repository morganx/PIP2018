...
ggsave("~/PIP2018/results/SupFig1-unfiltered.pdf", plot = last_plot(), device = NULL, path = NULL,
...
ggsave("~/PIP2018/results/Fig2A-unfiltered.pdf", plot = last_plot(), device = NULL, path = NULL,
  scale = 1, width = 9, height = 6, units = c("in", "cm", "mm"),
  dpi = 300, limitsize = FALSE)
```
...
m1$time <- factor(m1$time, levels = c("0", "3", "12", "24"))
