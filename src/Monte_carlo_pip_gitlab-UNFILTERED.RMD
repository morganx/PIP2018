...
# Filter the whole dataset at each time on E.coli > 1.5IQR. Except don't really.
Taxonomy_filtered_AtBirth<-subset(E_coli_abundance_AtBirth, E_coli<=100)
Taxonomy_filtered_3_month<-subset(E_coli_abundance_3_month,E_coli<=100)
Taxonomy_filtered_12_month<-subset(E_coli_abundance_12_month,E_coli<=100)
Taxonomy_filtered_24_month<-subset(E_coli_abundance_24_month,E_coli<=100)
...
#ggsave("~/pip-resubmit/results/unfiltered-time_tax.pdf", plot = last_plot(), device = #NULL, path = NULL,
...
#ggsave("~/pip-resubmit/results/unfiltered-caesartax.pdf", plot = last_plot(), device = #NULL, path = NULL,
#  scale = 1, width = 9, height = 6, units = c("in", "cm", "mm"),
#  dpi = 300, limitsize = FALSE)
...
#ggsave("~/pip-resubmit/results/unfiltered-abx-tax.pdf", plot = last_plot(), device = NULL, path = NULL,
 # scale = 1, width = 9, height = 6, units = c("in", "cm", "mm"),
#  dpi = 300, limitsize = FALSE)
...
#ggsave("~/pip-resubmit/results/unfiltered-tax-studygroup.pdf", plot = last_plot(), device #= NULL, path = NULL,
#  scale = 1, width = 9, height = 6, units = c("in", "cm", "mm"),
 # dpi = 300, limitsize = FALSE)
```
...
Module<-import_qiime_sample_data("~/PIP/primary_data/modules.pcl")
...
#ggsave("~/pip-resubmit/results/unfiltered-mod-time.pdf", plot = last_plot(), device = NULL, path = NULL,
 # scale = 1, width = 9, height = 6, units = c("in", "cm", "mm"),
#  dpi = 300, limitsize = FALSE)
...
#ggsave("~/pip-resubmit/results/unfiltered-mod-caesar.pdf", plot = last_plot(), device = NULL, path = NULL,
 # scale = 1, width = 9, height = 6, units = c("in", "cm", "mm"),
  #dpi = 300, limitsize = FALSE)
...
#ggsave("~/pip-resubmit/results/unfiltered-mod-anti.pdf", plot = last_plot(), device = NULL, path = NULL,
  #scale = 1, width = 9, height = 6, units = c("in", "cm", "mm"),
 # dpi = 300, limitsize = FALSE)
```
...
#ggsave("~/pip-resubmit/results/unfiltered-mod-studygroup.pdf", plot = last_plot(), device #= NULL, path = NULL,
#  scale = 1, width = 9, height = 6, units = c("in", "cm", "mm"),
#  dpi = 300, limitsize = FALSE)
...
ggsave("~/PIP2018/results/fig4-unfiltered.pdf", plot = last_plot(), device = NULL, path = NULL,
  scale = 1, width = 9, height = 6, units = c("in", "cm", "mm"),
  dpi = 300, limitsize = FALSE)
...
ggsave("~/PIP2018/results/supfig5-unfiltered.pdf", plot = last_plot(), device = NULL, path = NULL,
  scale = 1, width = 9, height = 6, units = c("in", "cm", "mm"),
  dpi = 300, limitsize = FALSE)
```
